...
Begin VB.Form frm_EkBP_rekap 
   ...
   Begin VB.Label lb_caption 
      ...
      Caption         =   "Ekualisasi : Data BP / Bukti Potong - Rekap"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frm_EkBP_rekap"
...
Function generate_sql() As String
    ...
    sql = "select tahun, kode_proyek_lama,  sum(dpp), sum(pph) " & _
            "From all2016_bp "
    ...
    sql = sql & "group by tahun, kode_proyek_lama "
