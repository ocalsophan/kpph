...
Begin VB.Form frm_Ebupot23_res_imp 
   ...
   Begin VB.Label lb_caption 
      ...
      Caption         =   " Import hasil export ebupot23 (dari DJP- no Bukti Potong)"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frm_Ebupot23_res_imp"
...
Private Sub cmd_browse_Click()
    ...
    If Trim(f) <> "" Then
        ...
        If is_file_ada(f) = True Then
            ...
            Else
                Call Load_Excel_2Rs(fl, 1, rs, Me.StatusBar1, 1, 2)
    ...
    '-- jika jumlah kolom <> 15
    If rs.Fields.Count <> 16 Then
        MsgBox "Jumlah kolom tidak valid. " & vbCr & _
                "Pastikan kolom N kosong sudah di hapus", vbCritical
...
Private Sub cmd_import_Click()
    ...
    Do While rs.EOF = False
        ...
        If data_Valid = True Then
            ...
            ret1 = tbebupot23_res_insert(rsParam, True)
            If ret1 = "" Then
...
Private Sub cmd_info_Click()
    ...
    On Error GoTo er1
    MsgBox "Data dari DJP. Contoh file terlampir", vbInformation
    File1 = "explorer.exe " & App.Path & "\rep\hasil_export_buktipotong_112020.xls"
