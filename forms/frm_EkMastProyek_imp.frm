...
Begin VB.Form frm_EkMastProyek_imp 
   ...
   Begin VB.Label lb_caption 
      ...
      Caption         =   "Ekualisasi PPn / PPh : Import Master Proyek"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frm_EkMastProyek_imp"
...
Private Sub cmd_import_Click()
    ...
    Dim NO1 As String, CABANG As String, DIVISI As String, kode_proyek_lama As String
    Dim kode_proyek_baru As String, nama_proyek As String, NPWP_OWNER As String
    Dim NAMA_OWNER  As String, NO_KONTRAK As String, NK_PPN As Currency, KETERANGAN As String
    ...
    Do While rs.EOF = False
        ...
        'ssssssssssssssssss
        NO1 = cleanStr(rs(0))
        CABANG = cleanStr(rs(1))
        DIVISI = cleanStr(rs(2))
        kode_proyek_lama = cleanStr(rs(3))
        kode_proyek_baru = cleanStr(rs(4))
        nama_proyek = cleanStr(rs(5))
        NPWP_OWNER = cleanStr(rs(6))
        NAMA_OWNER = cleanStr(rs(7))
        NO_KONTRAK = cleanStr(rs(8))
        NK_PPN = cek_Money(cleanStr(rs(9)))
        KETERANGAN = cleanStr(rs(10))
     
        If Trim(NO1) = "" Then
            data_Valid = False
            Me.List1.AddItem "Data ke " & c & " No tidak valid"
        ...
        If data_Valid = True Then
            ret1 = tbAll2016_master_insert(NO1, CABANG, DIVISI, NO_KONTRAK, NK_PPN, NAMA_OWNER, _
                                        nama_proyek, "", kode_proyek_lama, kode_proyek_baru, _
                                        KETERANGAN, NPWP_OWNER)
            If ret1 = "" Then
            ...
            Else
                ...
                p = MsgBox("Tetap lanjut import?", vbYesNo)
                If p = vbNo Then
                    Me.Enable_Form
                    Exit Sub
                End If
...
Private Sub cmd_info_Click()
    ...
    On Error GoTo er1
    File1 = "explorer.exe " & App.Path & "\rep\ekualisasi_imp_proyek.xlsx"
