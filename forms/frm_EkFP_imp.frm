...
Begin VB.Form frm_EkFP_imp 
   ...
   Begin VB.Label lb_caption 
      ...
      Caption         =   "Ekualisasi PPn / PPh : Import FP - Pajak Keluaran"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frm_EkFP_imp"
...
Private Sub cmd_import_Click()
    ...
    Do While rs.EOF = False
        ...
        If data_Valid = True Then
            ret1 = tbAll2016_fp_insert(kode_divisi, kode_proyek_lama, kode_proyek_baru, _
                                    tahun, tgl_fp, no_fp, dpp, ppn, KETERANGAN, False)
            If ret1 = "" Then
...
Private Sub cmd_info_Click()
    ...
    On Error GoTo er1
    MsgBox "Data FP di import per tahun!!", vbInformation
    File1 = "explorer.exe " & App.Path & "\rep\ekualisasi_imp_fp.xlsx"
