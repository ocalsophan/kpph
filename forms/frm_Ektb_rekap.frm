...
Begin VB.Form frm_Ektb_rekap 
   ...
   Begin VB.Label lb_caption 
      ...
      Caption         =   "Ekualisasi : Data Trial Balance - Rekap"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frm_Ektb_rekap"
...
Function generate_sql() As String
    ...
    sql = "select tahun, bulan, kode_proyek_lama, kode_proyek_baru, " & _
            "sum(debit), sum(kredit), if(sum(debit) = sum(kredit),'ok','') " & _
            "From all2016_tb "
    ...
    sql = sql & "group by tahun, bulan, kode_proyek_lama, kode_proyek_baru "
...
Sub format_Grid()
    ...
    If jRec <= 0 Then Exit Sub
        ...
        For c = 0 To rs.Fields.Count - 1
            ...
            'kecil
            If c = 0 Or c = 1 Or c = 3 Or c = 6 Then
