...
Begin VB.Form frm_EkBP 
   ...
   Begin VB.Label lb_caption 
      ...
      Caption         =   "Ekualisasi : Data Bukti Potong"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
...
Function generate_sql() As String
    ...
    sql = "Select id1, kode_divisi, kode_proyek_lama, " & _
        "kode_proyek_baru, tahun, tgl_bp, " & _
        "no_bp, dpp, pph, no_fp " & _
        "keterangan " & _
        "From all2016_bp "
    ...
    sql = sql & " order by tahun desc, kode_proyek_lama, kode_proyek_baru, tgl_bp "
...
Private Sub Form_Load()
  ...
  'load combo
  Me.txt_cari.text = ""
  sql = "select distinct tahun from all2016_bp"
  Call Load_combo(Me.cb_tahun, sql, cnn, True, , 1)
  sql = "select distinct kode_proyek_lama from all2016_bp"
