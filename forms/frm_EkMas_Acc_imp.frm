...
Begin VB.Form frm_EkMas_Acc_imp 
   ...
   Begin VB.Label lb_caption 
      ...
      Caption         =   "Ekualisasi PPn / PPh : Import COA"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frm_EkMas_Acc_imp"
...
Private Sub cmd_import_Click()
    ...
    Dim NO1 As String, account As String, accpac As String, acct_name As String
    ...
    Do While rs.EOF = False
        ...
        'ssssssssssssssssss
        NO1 = cleanStr(rs(0))
        account = cleanStr(rs(1))
        accpac = cleanStr(rs(2))
        acct_name = cleanStr(rs(3))
     
        If Trim(NO1) = "" Then
            data_Valid = False
            Me.List1.AddItem "Data ke " & c & " No tidak valid"
            Me.List1.ListIndex = Me.List1.ListCount - 1
        ElseIf Trim(account) = "" Or Trim(acct_name) = "" Then
            data_Valid = False
            Me.List1.AddItem "Data ke " & c & "  account/acct_name tidak valid"
            Me.List1.ListIndex = Me.List1.ListCount - 1
        End If
    
        If data_Valid = True Then
            ret1 = tbAll2016_maccount_insert(account, accpac, acct_name)
            If ret1 = "" Then
...
Private Sub cmd_info_Click()
    ...
    On Error GoTo er1
    File1 = "explorer.exe " & App.Path & "\rep\ekualisasi_imp_COA.xlsx"
